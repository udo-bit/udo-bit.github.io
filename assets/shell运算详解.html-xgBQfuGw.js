import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,d as i}from"./app-DedkmrMl.js";const e={},l=i(`<p><strong>计算机编程就是三大步：输入、运算、输出</strong></p><p>那么计算机运算有哪些呢，计算机能做哪些运算呢？</p><p><strong>我们来看看常见的计算机运算</strong></p><h2 id="一、赋值运算" tabindex="-1"><a class="header-anchor" href="#一、赋值运算"><span>一、赋值运算</span></a></h2><p>赋值运算符 =</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span> 	a=10   </span></span>
